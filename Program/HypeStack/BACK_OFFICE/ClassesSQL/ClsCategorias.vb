...
Public Class ClsCategorias
    ...
    Friend Shared Function GetNovoCodigo() As String
        ...
        Return "CATG" & ClsEmpresas.GetContador(enCont.Categorias).ToString("00") ' <-------------- VERIFICAR O Nº de ZEROS

    End Function

    Public Shared Function GetCategoriasByNome(ByVal pNome As String) As List(Of ClsCategorias)
    ...
    Public Shared Function GravaCategorias(ByVal pNovoCategorias As ClsCategorias) As Boolean
        ...
        Try
            mCMD.ExecuteNonQuery()
            ClsEmpresas.GravaContador(enCont.Categorias)
        Catch ex As Exception
    ...
    Public Shared Function ApagaCategorias(ByVal pCod_Categoria As String) As Boolean
        ...
        ClsEmpresas.DowngradeContadores(3)
