...
Public Class ClsEnderecos
    ...
    'Return "E" & ClsEmpresas.GetContador(enCont.Enderecos).ToString("000")' <-------------- VERIFICAR O Nº de ZEROS
    ...
    '''      (c) ETLA - PM-2022
    ''' </remarks>
    Public Shared Function GetEnderecos() As List(Of ClsEnderecos)
    ...
    ''' <summary>
    '''      Function GetEnderecosByCod(ByVal pCod_Entidade As Integer) Método para decolver uma Classe de Enderecos
    '''      Gerado em 29/11/2022 16:04:41
    ''' </summary>
    ''' <returns>
    '''      mClsEnderecos
    ...
    '''      (c) ETLA - PM-2022
    ''' </remarks>
    Public Shared Function GetEnderecosByCod(ByVal pCod_Entidade As Integer) As ClsEnderecos
        Dim mClsEnderecos As New ClsEnderecos
    ...
    Public Shared Function ModificaEnderecos(ByVal pClsEnderecos As ClsEnderecos) As Boolean
        ...
        mCMD.Parameters.Clear()
        mCMD.Parameters.AddWithValue("@pCod_Entidade", pClsEnderecos.Cod_Entidade)
    ...
    Public Shared Function GravaEnderecos(ByVal pNovoEnderecos As ClsEnderecos) As Boolean
        ...
        mCMD.Parameters.AddWithValue("@pCod_Entidade", pNovoEnderecos.Cod_Entidade)
    ...
    ''' <summary>
    '''      Function ApagaEnderecos(ByVal pCod_Entidade As Integer) Método para Apagar um Registo da Tabela Enderecos
    '''      Gerado em 29/11/2022 16:04:41
    ''' </summary>
    ''' <returns>
    '''      Boolean
    ...
    '''      (c) ETLA - PM-2022
    ''' </remarks>
    Public Shared Function ApagaEnderecos(ByVal pCod_Entidade As Integer) As Boolean
        Dim mReturn As Boolean = True
