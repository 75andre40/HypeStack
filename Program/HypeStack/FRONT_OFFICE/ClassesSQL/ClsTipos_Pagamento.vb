...
Public Class ClsTipos_Pagamento
    ...
    Public Shared Function ModificaTipos_Pagamento(ByVal pClsTipos_Pagamento As ClsTipos_Pagamento) As Boolean
        ...
        mCMD.Parameters.AddWithValue("@pImagem", pClsTipos_Pagamento.Imagem.Substring(0, IIf(Len(pClsTipos_Pagamento.Imagem) > 15, 15, Len(pClsTipos_Pagamento.Imagem))))
    ...
    Public Shared Function GravaTipos_Pagamento(ByVal pNovoTipos_Pagamento As ClsTipos_Pagamento) As Boolean
        ...
        mCMD.Parameters.AddWithValue("@pImagem", pNovoTipos_Pagamento.Imagem.Substring(0, IIf(Len(pNovoTipos_Pagamento.Imagem) > 15, 15, Len(pNovoTipos_Pagamento.Imagem))))
