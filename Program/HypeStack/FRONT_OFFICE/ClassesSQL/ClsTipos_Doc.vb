...
Public Class ClsTipos_Doc
    ...
    Public Shared Function GetTipos_DocByESC(ByVal Letter As Char) As List(Of ClsTipos_Doc)
    ...
    '''      (c) ETLA - PM-2022
    ''' </remarks>
    Public Shared Function GetTipos_Doc() As List(Of ClsTipos_Doc)
        Dim mListaTipos_Doc As New List(Of ClsTipos_Doc)
