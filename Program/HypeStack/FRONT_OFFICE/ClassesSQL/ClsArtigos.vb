...
Public Class ClsArtigos
    ...
    Public ReadOnly Property Taxa_IVA As Decimal
        ...
        End Get
    End Property
    Public ReadOnly Property P_CDesconto As Decimal
        Get
            P_CDesconto = Math.Round(Preco_Venda - Preco_Venda * (Desconto / 100), 2)

        End Get
    End Property
    Public ReadOnly Property P_Final As Decimal
        Get
            Dim P_CDesc = Preco_Venda - Preco_Venda * (Desconto / 100)
            P_Final = Math.Round(P_CDesc + P_CDesc * Taxa_IVA, 2)
        End Get
    End Property
