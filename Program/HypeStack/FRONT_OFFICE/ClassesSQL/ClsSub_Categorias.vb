...
Public Class ClsSub_Categorias
    ...
    Friend Shared Function GetNovoCodigo() As String
        ...
        Return "S" & ClsEmpresas.GetContador(enCont.Sub_Categorias).ToString("000") ' <-------------- VERIFICAR O Nº de ZEROS
    ...
    Public Shared Function GetSub_CategoriasByTipo(ByVal pCod_Categoria As String) As List(Of ClsSub_Categorias)
        Dim mListaSub_Categorias As New List(Of ClsSub_Categorias)
